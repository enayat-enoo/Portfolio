    ...
    <div style={{ background: "var(--bg)", color: "var(--text)" }}>
      ...
      <div
        ...
        style={{
          ...
          alignItems: "center",
          padding:
            "clamp(5rem, 12vw, 7rem) clamp(1.25rem, 5vw, 2.5rem) clamp(3rem, 6vw, 4rem)",
          maxWidth: "1100px",
          margin: "0 auto",
        }}
      >
        <div style={{ maxWidth: "820px", width: "100%" }}>
          ...
          >
            Full Stack Developer at Venturesathi, building enterprise web apps
            using the PERN stack,and AWS SES/SNS.
          </p>
          ...
          <div style={{ display: "flex", gap: "0.75rem", flexWrap: "wrap" }}>
            {[
              {
                label: "Get in Touch ↗",
                href: "mailto:enayatansari33@gmail.com",
                primary: true,
              },
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Contributing to the development and maintenance of enterprise web
              applications, collaborating across the full software development
              lifecycle.
            </p>

            <ul style={{ listStyle: "none", marginBottom: "1rem" }}>
              {[
                "Developing and maintaining PERN stack applications",
                "Implemented AWS SES/SNS based email infrastructure",
                "Built and optimized internal HRMS and communication modules",
                "Collaborated with product and engineering teams on production deployments",
              ].map((item, i) => (
                <li
                  key={i}
                  style={{
          ...
          >
            <div>
              ...
              >
                Independent Client — Retail Business
              </div>
            </div>
            <div
              style={{
          ...
          >
            Contracted to build a production-grade, GST-compliant billing and
            invoice management system. Delivered a complete MERN stack
            application with multi-user support and real-time reporting.
          </p>
          <ul style={{ listStyle: "none", marginBottom: "1rem" }}>
            {[
        ...
        <div
          ref={ref}
          className="thesis-card fade-in"
          style={{
            background:
              "linear-gradient(135deg, var(--surface) 0%, #0f1f18 100%)",
            border: "1px solid var(--accent-border)",
            borderRadius: "12px",
        ...
        >
          ...
          >
            ⬡ M.Tech Research — RGPV University
          </div>
          ...
          >
            Latency vs Throughput in Horizontally Scaled Real-Time Communication
            Architectures
          </h3>
          <p
            style={{
          ...
          >
            Comparative analysis of Redis Pub/Sub against direct WebSocket
            broadcasting in multi-node Node.js clusters. Benchmarked message
            latency, throughput, and failure modes under concurrency stress.
          </p>

          <div
            className="thesis-metrics"
            style={{
              display: "flex",
              gap: "2.5rem",
              flexWrap: "wrap",
          ...
          <div style={{ display: "flex", gap: "0.5rem", flexWrap: "wrap" }}>
            {["Redis Pub/Sub", "WebSockets"].map((t) => (
              <span key={t} style={T.tagH}>
                {t}
              </span>
            ))}
            {[
          ...
          {[
            {
              ...
              links: [
                {
                  label: "↗ Live Demo",
                  href: "https://quick-chat-eight-eta.vercel.app/",
                  live: true,
                },
                {
                  label: "⌥ GitHub",
                  href: "https://github.com/enayat-enoo/Quickchat",
                  live: true,
                },
              ],
            },
            {
              ...
              links: [
                {
                  label: "↗ Live Demo",
                  href: "https://crypto-monitor-dun.vercel.app/",
                  live: true,
                },
                {
                  label: "⌥ GitHub",
                  href: "https://github.com/enayat-enoo/crypto-price-monitor",
                  live: true,
                },
              ],
            },
            {
              ...
              links: [
                {
                  label: "⌥ GitHub",
                  href: "https://github.com/enayat-enoo",
                  live: false,
                },
              ],
            },
            {
              ...
              links: [
                {
                  label: "↗ Live Demo",
                  href: "https://book-it-beryl.vercel.app/",
                  live: true,
                },
                {
                  label: "⌥ GitHub",
                  href: "https://github.com/enayat-enoo/BookIt",
                  live: false,
                },
              ],
            },
            {
              ...
              links: [
                {
                  label: "⌥ GitHub",
                  href: "https://github.com/enayat-enoo/E-com-cart",
                  live: false,
                },
              ],
            },
            ...
            >
              ...
              >
                {p.tags.map((t) => (
                  <span key={t.l} style={t.h ? T.tagH : T.tag}>
                    {t.l}
                  </span>
                ))}
              </div>
          ...
          {[
            ...
            >
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: "0.4rem" }}>
                {group.skills.map((s) => (
                  <span key={s.l} style={s.h ? T.tagH : T.tag}>
                    {s.l}
                  </span>
                ))}
              </div>
        ...
        >
          ...
          >
            {[
              {
                icon: "✉",
                label: "enayatansari33@gmail.com",
                href: "mailto:enayatansari33@gmail.com",
              },
              {
                icon: "⌥",
                label: "github.com/enayat-enoo",
                href: "https://github.com/enayat-enoo",
              },
              {
                icon: "in",
                label: "linkedin.com/in/md-enayat-ansari",
                href: "https://www.linkedin.com/in/md-enayat-ansari-856667228",
              },
              {
                icon: "↓",
              ...
              {
                icon: "☎",
                label: "+91 90749 32835",
                href: "tel:+919074932835",
              },
            ].map((link) => (
              <a
                key={link.label}
              ...
              >
                <span
                  style={{ width: "28px", textAlign: "center", flexShrink: 0 }}
                >
                  {link.icon}
                </span>
                <span
