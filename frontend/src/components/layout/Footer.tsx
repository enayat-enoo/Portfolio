      ...
      <div className="w-full max-w-6xl bg-white/20 backdrop-blur-xl border border-white/30 rounded-[40px] p-8 md:p-14 flex flex-col md:flex-row items-center gap-12 overflow-hidden shadow-xl">
        <div className="flex-1 text-center md:text-left space-y-8">
          ...
          <p className="text-slate-800 text-lg md:text-xl max-w-md leading-relaxed font-medium">
            I'm always open to discussing new projects, creative ideas, or the
            intersection of logic and literature.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
            <a
              href="mailto:enayatansari33@gmail.com"
              className="group flex items-center justify-center gap-2 bg-[#10B981] text-white px-6 py-4 rounded-2xl font-semibold shadow-lg transition-all duration-500 ease-in-out hover:bg-[#059669] hover:scale-105"
            >
              <Mail size={20} className="shrink-0" />

              <div className="flex items-center overflow-hidden">

                <span className="transition-all duration-500">Contact</span>

                <span className="max-w-0 opacity-0 whitespace-nowrap transition-all duration-500 ease-in-out group-hover:max-w-[300px] group-hover:opacity-100 group-hover:ml-2">
            ...
            <button
              className="flex items-center justify-center gap-2 bg-white/80 text-slate-800 px-8 py-4 rounded-2xl hover:bg-white transition-all shadow-sm font-semibold"
        ...
        <div className="w-full md:w-[420px] bg-white rounded-[32px] p-10 flex flex-col items-center shadow-2xl">
          <div className="flex gap-4 mb-10">
            ...
            <SocialIcon
              ...
              href="https://www.linkedin.com/in/md-enayat-ansari-856667228?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
            />
            <SocialIcon
              icon={<Github size={24} />}
...
const SocialIcon: React.FC<{ icon: React.ReactNode; href: string }> = ({
  icon,
  href,
}) => (
  <a
